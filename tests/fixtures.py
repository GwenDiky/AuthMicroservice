...
from auth.models.core import clear_db, sessionLocalAsync
...
def mock_redis_client(monkeypatch):
    ...
    async def mock_is_token_blacklisted(token):
    ...
    monkeypatch.setattr(
        "auth.utils.redis_client.is_token_blacklisted", mock_is_token_blacklisted
    )
    return mock
