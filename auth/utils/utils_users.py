...
from auth.exceptions import InvalidTokenException, AuthFailedException
...
async def refresh_token_of_current_user(
    ...
    return TokenSchema(access_token=new_token, token_type="Bearer")
